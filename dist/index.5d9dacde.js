...
form.addEventListener("submit", (event)=>{
    ...
    (0, _base.getWeather)(itemsearch.value).then((cityWeather)=>{
        (0, _weather.renderWeather)(cityWeather, weatherContainer);
    });
    if (itemsearch.value != "") itemsearch.value = "";
});
...
parcelHelpers.export(exports, "getWeather", ()=>getWeather) // export the getWeather function
;
const getWeather = (city)=>{
    const API_KEY = "https://api.openweathermap.org/data/2.5/weather?q=" + city + "&appid=38323b43470d1808c5e08a53ad54a09e";
    return fetch(`${API_KEY}`).then((response)=>{
...
const renderWeather = (weather, renderItems)=>{
    ...
    renderItems.innerHTML += `<div class="mt-2 card" >
      <div class="card-body">
